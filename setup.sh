...
echo "Checking VPS"
IZIN=$( curl https://raw.githubusercontent.com/sreyaeve/greenspace/main/ipvps | grep $MYIP )
if [ $MYIP = $IZIN ]; then
...
wget https://raw.githubusercontent.com/sreyaeve/greenspace/main/install/ssh-vpn.sh && chmod +x ssh-vpn.sh && screen -S ssh-vpn ./ssh-vpn.sh
wget https://raw.githubusercontent.com/sreyaeve/greenspace/main/websocket-python/websocket.sh && chmod +x websocket.sh && screen -S websocket.sh ./websocket.sh
...
wget https://raw.githubusercontent.com/sreyaeve/greenspace/main/sodosok.sh && chmod +x sodosok.sh && screen -S ss ./sodosok.sh
wget https://raw.githubusercontent.com/sreyaeve/greenspace/main/ins-vt.sh && chmod +x ins-vt.sh && sed -i -e 's/\r$//' ins-vt.sh && screen -S v2ray ./ins-vt.sh
#install ehmm
clear
#curl -s https://wildyscript.my.id/Edu/bcki.txt
#wget https://raw.githubusercontent.com/sreyaeve/x/main/gasss.sh && chmod +x gasss.sh && ./gasss.sh
#systemctl restart edu-proxy-nontls
#systemctl enable edu-proxy-nontls
wget https://raw.githubusercontent.com/sreyaeve/greenspace/main/websocket.sh && chmod +x websocket.sh && ./websocket.sh
wget https://raw.githubusercontent.com/sreyaeve/greenspace/main/ipsec.sh && chmod +x ipsec.sh && screen -S ipsec ./ipsec.sh
...
echo " "
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━Autoscript Premium by ZenHost━━━━━━━━━━━━━━━━━━━━━━━━━━" | tee -a log-install.txt
