...
vlesslink1="vless://${user}@${domain}:2083?path=/vless&security=tls&encryption=none&type=ws#${user}"
vlesslink2="vless://${user}@${domain}:8880?path=/vless&encryption=none&type=ws#${user}"
